...
class UserReportController {
	...
	static async mostWantedPositions(req, res) {
		try {
			let mostWantedPositions = await userReportService.mostWantedPositions(req.body.industry_id, req.body.date_from, req.body.date_to)
			// response
	...
	static async mostWantedProfessions(req, res) {
		try {
			let mostWantedPositions = await userReportService.mostWantedProfessions(req.body.industry_id, req.body.date_from, req.body.date_to)
			// response
			res.json(response.success(ka.request_success, mostWantedPositions))
		} catch (error) {
			res.json(response.error(error.message))
